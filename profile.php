	...
	if(!isset($_COOKIE["email"])){
		...
		if(!isset($_SESSION[$email])){
			...
			if($r=mysqli_fetch_array($rs)){
				...
				$dob = new DateTime($birthdate);//DtaeTImr object
   ...
   <div class="profile">
	...
	?>
   	        ...
   	        <div class="col-sm-4 row_2">
				<div class="flexslider">
				 ...
				 <form method="post" enctype="multipart/form-data" action="change_pic.php">
					 <div class="flexslider">
						<ul class="form-group">
							<p style="font-size:13px;"><b>Edit Profile Photo<b></p>
							<input type="file" name="photo" value="PHOTO" class="form-control"><br>
							<input type="submit" value="Profile Change" class="btn btn-success">
							<?php
								if(isset($_GET["success"])){
									?>
									<p style="font-size:12px;">Profile Photo Changed</p>
									<?php
								}
								else if(isset($_GET["error_img"])){
									?>
									<p style="font-size:12px;">Try Again</p>
									<?php
								}
							?>
						</ul>
				...
				<table class="table_working_hours">
		        	<tbody>
		        		<tr class="opened_1">
							...
							<td class="day_value"><?=$r[2]?></td>
						</tr>
					    <tr class="opened">
							<td class="day_label">Last Name :</td>
							<td class="day_value"><?=$r[3]?></td>
						</tr>
					    <tr class="opened">
					    ...
					    <tr class="opened">
							...
							<td class="day_value"><?=$r["marital_status"]?></td>
						</tr>
					    <tr class="opened">
					    ...
					    <tr class="closed">
							...
							<td class="day_value closed"><span><?=$r["education"]?></span></td>
						</tr>
						<tr class="closed">
						...
						<tr class="closed">
							...
							<td class="day_value closed"><span><?=$r["address"]?></span></td>
						</tr>
						<tr class="closed">
							<td class="day_label">Bio :</td>
							<td class="day_value closed"><span><?=$r["bio"]?></span></td>
						</tr>
				    </tbody>
				</table>
			</div>
				    	  ...
				    	  <table class="table_working_hours">
				        	<tbody>
				        		<tr class="opened_1">
									...
									<td class="day_value"><?=$r[2]?> <?=$r["3"]?></td>
								</tr>
								<tr class="opened">
									<td class="day_label">Sex :</td>
									<td class="day_value closed"><span><?=$r["gender"]?></span></td>
								</tr>
							    <tr class="opened">
									<td class="day_label">Marital Status :</td>
									<td class="day_value"><?=$r["marital_status"]?></td>
							    ...
							    <tr class="opened">
									...
									<td class="day_value"><?=$r["height"]?> cm</td>
								</tr>
								<tr class="opened">
									<td class="day_label">Drink :</td>
									<td class="day_value closed"><span><?=$r["drink"]?></span></td>
								</tr>
						    </tbody>
				          </table>
				         </div>
				          ...
				          <table class="table_working_hours">
				        	<tbody>
				        		<tr class="opened_1">
									...
									<td class="day_value"><?=$interval->y?></td>
								</tr>
								<tr class="opened_1">
									<td class="day_label">Date of Birth :</td>
									<td class="day_value"><?=$r["day"]?>-<?=$r["month"]?>-<?=$r["year"]?></td>
								</tr>
							    <tr class="opened">
									<td class="day_label">Weight :</td>
									<td class="day_value"><?=$r["weight"]?> kg</td>
								</tr>
							    <tr class="closed">
									<td class="day_label">Diet :</td>
									<td class="day_value closed"><span><?=$r["diet"]?></span></td>
								</tr>
							    <tr class="closed">
									<td class="day_label">Smoke :</td>
									<td class="day_value closed"><span><?=$r["smoke"]?></span></td>
								</tr>
						    </tbody>
				        </table>
				        </div>
				    	  ...
				    	  <table class="table_working_hours">
				        	<tbody>
				        		<tr class="opened">
									...
									<td class="day_value"><?=$r["education"]?></td>
								</tr>
							    <tr class="opened">
     ...
     <div class="col-md-4 profile_right">
       ...
       <div class="clearfix"> </div>
				<h5 style="text-decoration:underline;"> <a href="edit.php">Do you want to edit?</a></h5>
				<h5 style="text-decoration:underline;"> <a href="edit.php">Do you want to change password?</a></h5>
				<h5 style="text-decoration:underline;"> <a href="logout.php">Do you want to logout?</a></h5> 
				<h5 style="text-decoration:underline;"> <a href="register.php">If not a member?</a></h5>
		<div class="clearfix"> </div>
	<?php
	 }
	?>
