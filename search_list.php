...
<div class="grid_3">
  <div class="container">
   ...
   <div class="col-md-9 profile_left2">
	<?php
			if(empty($_REQUEST["gender"]) || empty($_REQUEST["state"]) || empty($_REQUEST["caste"]) || empty($_REQUEST["religion"]) ){
				...
				$rs=mysqli_query($conn,"select * from users where gender='$gender' AND state='$state' AND caste='$caste' AND religion='$religion' AND email !='$email'");
	    	...
	    	<table class="table_working_hours">
	        	<tbody>
	        		<tr class="opened_1">
						...
						<td class="day_value"><?=$r["first_name"]." ".$r["last_name"]?></td>
					</tr>
				    <tr class="opened">
