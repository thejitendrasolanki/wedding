		    ...
		    <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
			   ...
			   <div id="myTabContent" class="tab-content">
				  <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
	                ...
	                <div class="clearfix"> </div>
					<?php
						$rs=mysqli_query($conn,"select * from inbox where froms='$email'");
						while($r=mysqli_fetch_array($rs)){
							$dr=mysqli_query($conn,"select * from users where email='".$r["tos"]."'");
							$rd="";
	                ...
	                <div class="jobs-item with-thumb">
	                   <div class="thumb_top">
				        <div class="thumb"><a href="view_profile.php?id=<?=$r["to_code"]?>"><img src="photo/<?=$r["to_code"]?>.jpg" class="img-responsive" alt=""/></a></div>
					    <div class="jobs_right">
							<h6 class="title"><a href="view_profile.php"><?=$rd["first_name"]." ".$rd["last_name"]?></a></h6>
							<ul class="top-btns">
							...
							<pre class="description"><?=$r["message"]?></pre>
							<a class="description" href="view_profile.html" class="read-more">view full profile</a>
						</div>
						<div class="clearfix"> </div>
					   </div>
