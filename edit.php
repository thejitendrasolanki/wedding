   ...
   <div class="services">
	    ...
	    <?php
			if(isset($_GET["success"])){
				?>
				<h3 style="color:green">Changes Successfull</h3>
				<?php
			}
		...
		?>
		 <form method="post" action="update.php" enctype="multipart/form-data">
			...
			<div class="form-group">
		      ...
		      <input type="text" id="edit-name" name="fname" value="<?=$r["first_name"]?>" size="60" maxlength="60" class="form-text required">
		    </div>
			<div class="form-group">
		      <label for="edit-name">Last Name <span class="form-required" title="This field is required.">*</span></label>
		      <input type="text" id="edit-name" name="lname" value="<?=$r["last_name"]?>" size="60" maxlength="60" class="form-text required">
		    </div>
			<div class="form-group">
		      <label for="edit-name">Contact Number <span class="form-required" title="This field is required.">*</span></label>
		      <input type="text" id="edit-pass" name="contact_number" value="<?=$r["contact_number"]?>" size="60" maxlength="128" class="form-text required">
		    </div>
			<div class="form-group">
		      <label for="edit-name">Height(cm) <span class="form-required" title="This field is required.">*</span></label>
		      <input type="text" id="edit-name" name="height" value="<?=$r["height"]?>" size="60" maxlength="60" class="form-text required">
		    </div>
			<div class="form-group">
		      <label for="edit-name">Weight(kg) <span class="form-required" title="This field is required.">*</span></label>
		      <input type="text" id="edit-name" name="weight" value="<?=$r["weight"]?>" size="60" maxlength="60" class="form-text required">
		    </div>
			<div class="form-group">
		      <label for="edit-name">Marital Status <span class="form-required" title="This field is required.">*</span></label>
		      <input type="text" id="edit-name" name="marital_status" value="<?=$r["marital_status"]?>" size="60" maxlength="60" class="form-text required">
		    </div>
            ...
            <div class="col-sm-4 form_box2">
			 ...
			 <div class="form-group form-group1">
			  ...
			  <div class="form-group">
				 ...
				 <input type="text" class="form-control bio" name="address" value="<?=$r["address"]?>" rows="3"></textarea>
			  </div>
			  <div class="form-group">
			     <label for="edit-name">Bio <span class="form-required" title="This field is required.">*</span></label>
				 <input type="text" class="form-control bio" name="bio" value="<?=$r["bio"]?>" rows="3"></textarea>
			  </div>
			  ...
			  <div class="form-group">
				...
				<input type="text" id="edit-name" name="education" value="<?=$r["education"]?>" size="60" maxlength="60" class="form-text required">
		      </div>
			  <div class="form-group">
				<label for="edit-name">Occupation <span class="form-required" title="This field is required.">*</span></label>
				<input type="text" id="edit-name" name="occupation" value="<?=$r["occupation"]?>" size="60" maxlength="60" class="form-text required">
		      </div>
