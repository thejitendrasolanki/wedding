	...
	?>
	 <div class="col-md-8 profile_left">
			...
			<div class="col-sm-8 row_1">
				...
				<table class="table_working_hours">
		        	<tbody>
		        		<?php
							...
							else if(isset($_GET["error_cp"])){
								?>
								<h3 style="color:red">Wrong Email</h3>
								<?php
							}
							else if(isset($_GET["pass_mismatch"])){
								?>
						...
						<tr class="opened">
							<div class="form-actions">
								<td class="day_value"><input type="submit" id="edit-submit" value="Submit" class="btn_1 submit"></td>
							</div>
						</tr>
				    </tbody>
				</table>
				...
				<div class="clearfix"> </div>
						<br><h5><span style="text-decoration:underline;">Back to your profile :</span><a href="profile.php"> Profile</a><br></h5>
				<div class="clearfix"> </div>
			</div>
			<div class="clearfix"> </div>
		</div>
