   ...
   <div class="profile">
   	<?php
		if(isset($_GET["msg_success"])){
			...
			$rs=mysqli_query($conn,"select * from users where code='$id'");
	...
	?>
	 <div class="col-md-8 profile_left">
			...
			<div class="col_4">
				<div class="form-group">
					<form method="post" action="msg.php?id=<?=$r["code"]?>">
					<label for="edit-name">Message</label><br>
					<input type="text" id="edit-name" name="message" size="60" maxlength="60">
					<input type="submit" value="send" class="btn btn-seccess">
				</div>
			</div>
			<div class="clearfix"> </div>
		</div>
     ...
     <div class="col-md-4 profile_right">
     	<div class="newsletter">
		   <form>
			  <input type="text" name="ne" size="30" placeholder="Enter Profile ID :">
